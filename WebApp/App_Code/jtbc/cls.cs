namespace jtbc
{
    ...
    public static class cls
    {
        ...
        public static string dateAdd(string argInterval, int argNumber, string argDate)
        {
            string str = argDate;
            int num = argNumber;
            string str2 = argInterval;
            int num2 = 0;
            str = getDate(str);
            if (str2 == "s")
            {
            ...
            try
            {
                str = formatDate(DateTime.Parse(str).AddSeconds((double) num2).ToString());
            }
            catch
            {
            }

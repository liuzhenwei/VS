namespace jtbc
{
    ...
    public class account
    {
        ...
        {
            return (cls.getString(com.itake("global." + this.ngenre + ":config.nfpre", "cfg")) + argString);
        }
        ...
        public bool checkUsername(string argUserid, string argUsername, string argPassword)
        {
            ...
            {
                db db = new db();
                string str3 = cls.getString(com.itake("global." + this.ngenre + ":config.ndatabase", "cfg"));
                string argFpre = cls.getString(com.itake("global." + this.ngenre + ":config.nfpre", "cfg"));
        ...
        public object[,] getUserAry(string argUserid)
        {
            ...
            string argObject = cls.getString(com.itake("global." + this.ngenre + ":config.ndatabase", "cfg"));
            string argFPre = cls.getString(com.itake("global." + this.ngenre + ":config.nfpre", "cfg"));
        ...
        public int getUserID(string argUsername)
        {
            ...
            string str = cls.getSafeString(argUsername);
            db db = new db();
            string str2 = cls.getString(com.itake("global." + this.ngenre + ":config.ndatabase", "cfg"));
            string argFpre = cls.getString(com.itake("global." + this.ngenre + ":config.nfpre", "cfg"));
        ...
        {
			if (!cls.isEmpty(argGenre))
            {
				this.ngenre = argGenre;
            }
            this.ndatabase = cls.getString(com.itake("global." + this.ngenre + ":config.ndatabase", "cfg"));
        }
        ...
        public void updateProperty(string argField, string argValue, string argType, string argUserId)
        {
            ...
            if (argID != -1)
            {
                string argDatabase = cls.getString(com.itake("global." + this.ngenre + ":config.ndatabase", "cfg"));
                string argFpre = cls.getString(com.itake("global." + this.ngenre + ":config.nfpre", "cfg"));
